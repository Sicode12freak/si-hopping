...
export default function SingleProduct() {
  ...
  }, [id]); // Add 'id' as a dependency to ensure it's called only when 'id' changes

  if (!productInfo) {
    return <Typography>Loading...</Typography>; // Optional: Show a loading state while data is fetched
  }
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={12} md={5}>
            <Paper elevation={0} sx={{ height: "100vh", padding: 2 }}>
              ...
              <Box sx={{ display: "flex", justifyContent: "flex-start", gap: 2 }}>
                <Typography variant="h6" mt={1} fontWeight={"bolder"} color="green">
